...
NOMBRE_EXPERIMENTO = 'cant-colores-ralo'
...
def run(metodo, parametros, cantcolores):
    ...
    for instancia_path in glob.glob(INSTANCIAS_PATH_IN):
        ...
        filas.append([metodo, data[0], data[1], mH, impacto_promedio, tiempo, error, cantcolores,group]);
...
for i in range(0,3):
    parametros =f"0 1 0 {i} 0 50 0 -1 -1"
