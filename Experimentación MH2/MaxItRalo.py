...
NOMBRE_EXPERIMENTO = 'max-it-ralo'
...
def run(metodo, parametros, max_it):
    ...
    for instancia_path in glob.glob(INSTANCIAS_PATH_IN):
        ...
        filas.append([metodo, data[0], data[1], mHcota, impacto_promedio, tiempo, error, max_it,group]);
...
for i in range(0,3):
    parametros =f"0 {i} 0 1 2 50 0 -1 -1"
